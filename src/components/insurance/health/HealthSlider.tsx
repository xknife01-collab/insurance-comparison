...
export const HealthSlider: React.FC<{ result: AnalysisResult }> = ({ result }) => {
  ...
  return (
    <section className="space-y-16">
      <div className="text-center space-y-6">
        <div className="inline-flex items-center gap-2 px-6 py-2 bg-orange-900 text-white rounded-full text-[0.65rem] font-black uppercase tracking-[0.3em] shadow-xl">
          <Calculator size={14} className="text-orange-500" /> Premium Simulation
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center relative z-10">
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-2">
                  <p className="text-[0.85rem] font-bold text-gray-600 leading-relaxed">
                    설정하신 월 예산에 맞춰 통합 질환 예상 보장 한도가 <span className="text-orange-600 font-black underline decoration-2 underline-offset-4">{metrics.benefit.toLocaleString()}만 원</span>으로 실시간 맞춤 조율되는 것을 확인하실 수 있습니다.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-slate-900 rounded-[3rem] p-10 text-white space-y-6 shadow-2xl">
              ...
              <div>
                <p className="text-[0.65rem] font-black text-slate-400 uppercase tracking-widest mb-1">통합 질환 예상 보장 한도</p>
              ...
              <div className="h-1.5 bg-white/10 rounded-full overflow-hidden"><motion.div initial={{ width: 0 }} animate={{ width: `${(metrics.benefit / 10000) * 100}%` }} className="h-full bg-orange-500" /></div>
            </div>
