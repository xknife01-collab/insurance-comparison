    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
        {[
          ...
          <div key={i} className="bg-white border border-amber-100 rounded-[3rem] p-8 text-center shadow-sm hover:shadow-xl hover:border-amber-200 transition-all group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        ...
        {/* CDR 척도 카드 */}
        <div className="bg-white rounded-[4rem] p-12 border border-amber-100 shadow-lg hover:shadow-2xl transition-all group">
          <div className="flex items-center gap-4 mb-10">
            <div className="w-16 h-16 bg-amber-500 rounded-[2rem] flex items-center justify-center text-white shadow-lg group-hover:rotate-6 transition-transform">
        ...
        <div className="bg-slate-900 rounded-[4rem] p-12 text-white shadow-2xl relative overflow-hidden group flex flex-col justify-between">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-10">
              <div className="w-16 h-16 bg-amber-500 rounded-[2.2rem] flex items-center justify-center text-white shadow-xl">
            ...
            <div className="space-y-6">
              ...
              {/* 간병비 중심형 */}
              <div className="p-8 bg-amber-500/20 rounded-[2.5rem] border border-amber-400/30 hover:bg-amber-500/30 transition-colors">
                <p className="font-black text-amber-300 mb-3 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
        <div className="md:col-span-2 bg-white border border-amber-100 rounded-[4rem] p-12 shadow-sm hover:shadow-xl transition-all">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-amber-600 text-white rounded-[3.5rem] p-10 shadow-xl">
          ...
          <div className="bg-white border border-amber-100 rounded-[3.5rem] p-10 shadow-sm hover:shadow-xl transition-all">
      ...
      {/* ── 보험사별 상품 비교 ── */}
      <div className="mb-20 bg-white rounded-[4rem] p-12 border border-amber-100 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="p-8 bg-amber-50/40 rounded-[2.5rem] border border-amber-100 hover:border-amber-300 hover:shadow-lg transition-all">
