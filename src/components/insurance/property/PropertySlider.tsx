              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-2 text-left">
                  <p className="text-[0.85rem] font-bold text-gray-600 leading-relaxed">
                    설정하신 월 예산에 맞춰 건물 화재 실손보상 및 배상책임 한도가 <span className="text-blue-600 font-black underline decoration-2 underline-offset-4">{metrics.buildingLimit >= 10000 ? `${(metrics.buildingLimit / 10000).toFixed(1)}억` : `${metrics.buildingLimit}만`} 원</span>으로 실시간 맞춤 조율되는 것을 확인하실 수 있습니다.
                  </p>
                </div>
              </div>
            </div>
