...
import { SurgeryDetailedGuide } from './SurgeryDetailedGuide';
    ...
    <section className="space-y-16">
      <div className="text-center space-y-6">
        <div className="inline-flex items-center gap-2 px-6 py-2 bg-amber-900 text-white rounded-full text-[0.65rem] font-black uppercase tracking-[0.3em] shadow-xl">
          <Calculator size={14} className="text-amber-500" /> Surgery Simulation
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center relative z-10">
            ...
            <div className="space-y-8">
              ...
              <div className="relative pt-10 pb-6">
                ...
                <div className="flex justify-between mt-6 text-[0.65rem] font-black text-gray-400 uppercase tracking-widest">
                  ...
                  <span className="text-amber-500">현재 ({currentPremium.toLocaleString()}원)</span>
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[0.85rem] font-bold text-gray-600 leading-relaxed">
                    수술/입원 보험료를 세이브하여 설계하면 1-5종 수술비 혜택의 크기가 <span className="text-amber-600 font-black underline decoration-2 underline-offset-4">{metrics.percentage}% 달라지는 것</span>을 확인하실 수 있습니다.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-slate-900 rounded-[3rem] p-10 text-white space-y-6 shadow-2xl">
              ...
              <div className="h-1.5 bg-white/10 rounded-full overflow-hidden"><motion.div initial={{ width: 0 }} animate={{ width: `${(metrics.benefit / 1000) * 100}%` }} className="h-full bg-amber-500" /></div>
            </div>
            <div className="bg-white rounded-[3rem] p-10 border border-gray-100 space-y-6 shadow-xl">
              ...
              <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden"><motion.div initial={{ width: 0 }} animate={{ width: `${metrics.index}%` }} className="h-full bg-amber-500" /></div>
            </div>
          </div>
        </div>
        <SurgeryDetailedGuide />
      </div>
    </section>
  );
};
