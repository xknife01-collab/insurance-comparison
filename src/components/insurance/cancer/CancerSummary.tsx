...
export const CancerSummary: React.FC<Props> = ({ result, formatAmount }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 월 예상 절감액 섹션 */}
      <div className="bg-gradient-to-r from-rose-500 to-pink-600 rounded-[2.5rem] p-10 text-white shadow-xl relative overflow-hidden">
          ...
          <div className="text-right">
            {savings > 0 ? (
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-xl font-bold text-rose-100">원 절감</span>
              </div>
            ) : (
              <div className="flex items-baseline gap-2">
            ...
            <p className="text-[10px] text-rose-200 font-bold mt-2 opacity-60 uppercase tracking-widest">
              * 추천 상품 기준 예상 수치
            </p>
          </div>
        </div>
