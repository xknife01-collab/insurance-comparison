    ...
    <div className="mt-16 space-y-16 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <div className="bg-gradient-to-br from-red-950 via-slate-900 to-slate-950 rounded-3xl md:rounded-[3rem] p-5 md:p-12 md:p-20 text-center space-y-8 relative overflow-hidden shadow-2xl border border-red-500/20">
        ...
        <div className="relative z-10 space-y-6 max-w-4xl mx-auto">
          ...
          <p className="text-red-200/80 font-semibold text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            건강보험심사평가원 통계에 따르면 심장 질환의 대다수는 협심증(I20)과 허혈성 질환이 차지합니다. 급성심근경색증(I21~I23)에 국한되지 않고 다빈도 협심증과 부정맥(I49), 심부전(I50)까지 폭넓게 구성하는 가이드입니다.
          </p>
        </div>
      </div>

      {/* ── [필수 고지] 예시 보장금액 산출 기준 및 계약자 유의사항 ── */}
      <div className="bg-white rounded-3xl border border-red-200 p-6 md:p-8 shadow-sm">
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 rounded-2xl bg-red-100 flex items-center justify-center shrink-0 text-red-600 mt-1">
          ...
          <div className="flex-1 text-xs text-slate-600 space-y-2 leading-relaxed">
            <div className="flex flex-wrap items-center gap-2 mb-1">
              ...
              <span className="bg-red-100 text-red-700 font-bold px-2 py-0.5 rounded text-[10px]">손해보험협회 공시 기준</span>
            </div>
            <p className="font-bold text-slate-700">
              • **예시 산출 기준**: 주요 손해보험사 심장질환 표준 플랜 / 40세 남성 / 상해 1급(사무직) / 20년납 90세만기 / 해약환급금 미지급형(무해지형) / 월 보험료 26,800원 기준 (가입자의 연령, 성별, 직업, 특약 선택 및 회사별 심사 기준에 따라 실제 보험료와 보장금액은 상이할 수 있습니다).
            </p>
            <div className="pt-2 border-t border-red-100 text-[11px] text-slate-500 space-y-1">
              <p>• **진단비 지급 조건**: 허혈성 심장질환 및 특정 심혈관 진단비 특약은 보험기간 중 최초 1회에 한하여 지급된 후 해당 특약은 소멸됩니다 (통합형/산정특례 특약 등 별도 가입 시 제외).</p>
              <p>• **진단 확정 요건 안내**: 심장질환의 진단 확정은 의료법 제3조에 의한 병원 또는 의원의 순환기내과(심장내과) 또는 흉부외과 전문의 자격을 가진 자에 의하여 내려져야 하며, 심전도, 심초음파, 관상동맥(심장혈관) 조영술, 혈액검사(트로포닌 등 심장 효소 검사) 등의 정밀검사 결과를 기초로 해야 합니다.</p>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          {
            title: '심장질환 광범위 보장',
            desc: '급성심근경색증과 협심증은 물론, 부정맥(I49), 심방세동(I48), 심부전(I50)까지 심장 주요 이상 보장.',
            tag: '넓은 보장 범위',
          ...
          {
            title: '관혈 / 비관혈 매회 수술비',
            desc: '가슴을 여는 개흉 수술뿐 아니라 카테터 스텐트 삽입, 풍선 확장 등 비관혈 수술 약관상 매회 정액 지급.',
            tag: '수술비 반복 보장',
          ...
          {
            title: '산정특례 위로 진단비',
            desc: '중증 심장 질환으로 국가 산정특례 환자 등록 시, 약관 기준에 따라 추가 위로금 보장.',
            tag: '중증 재발 대비',
          ...
          {
            title: '부정맥 & 협심증 대비',
            desc: '건강보험심사평가원 통계 기준 다빈도 협심증(I20)과 심장 부정맥(I49) 진단 코드 집중 보완 설계.',
            tag: '다빈도 질환 대비',
      ...
      <div className="bg-white rounded-3xl md:rounded-[4rem] p-5 md:p-8 md:p-16 border border-gray-100 shadow-xl space-y-12">
          ...
          <div className="bg-slate-50 rounded-2xl md:rounded-[2.5rem] p-5 md:p-8 border border-slate-100 flex flex-col justify-between space-y-6 opacity-80">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-[10px] font-black text-rose-600 bg-rose-50 px-2 py-0.5 rounded border border-rose-100">심평원 통계 기준 약 60%</span>
              </div>
          ...
          <div className="bg-slate-50 rounded-2xl md:rounded-[2.5rem] p-5 md:p-8 border border-red-100 flex flex-col justify-between space-y-6 shadow-[0_10px_30px_-5px_rgba(239,68,68,0.05)]">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-[10px] font-black text-red-600 bg-red-50 px-2 py-0.5 rounded border border-red-200">KCD I20~I25, I47~I50 보장</span>
              </div>
              <p className="text-xs text-red-950 font-bold leading-relaxed">
                급성심근경색 및 협심증은 기본이고, 심장이 불규칙하게 뛰는 부정맥(I49), 빈맥(I47), 심방세동(I48) 및 판막 이상, 심부전(I50)까지 약관 기준에 따라 보장합니다.
              </p>
              <div className="p-4 bg-white rounded-2xl border border-slate-100 space-y-2">
        ...
        <div className="bg-gradient-to-br from-red-50 to-rose-100/50 rounded-3xl md:rounded-[3rem] p-5 md:p-8 md:p-12 border border-red-100 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-2">
            <h4 className="text-lg font-black text-red-900 flex items-center gap-2">
              <Sparkles className="w-5 h-5 text-red-600" /> 스트레스와 과로로 다빈도 진단되는 '기타 심장 부정맥(I49)'
            </h4>
            <p className="text-xs text-gray-500 font-bold leading-relaxed max-w-2xl">
              부정맥은 심장의 전기 신호 이상으로 맥박이 빠르거나 느리게 뛰는 상태입니다. 피로와 스트레스로 가슴이 쿵쾅거리는 증상부터 실신, 뇌졸중을 유발하는 심방세동까지 발병 빈도가 높습니다. 직장인 건강검진 심전도 검사 시 자주 진단 소견이 나오는 이 부정맥은 **급성심근경색이나 허혈성 특약만으로는 지급 대상에서 제외될 수 있으므로, 약관상 보장 범위를 꼭 확인하셔야 합니다.**
            </p>
          </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-3xl md:rounded-[3.5rem] p-6 md:p-10 md:p-14 border border-gray-100 shadow-xl flex flex-col justify-between space-y-8">
          <div className="space-y-6">
            ...
            <p className="text-xs text-gray-500 font-bold leading-relaxed">
              심근경색으로 관상동맥 우회술을 받거나 약물 치료로 입원하는 중증 환자는 국가 중증질환 '산정특례' 대상으로 분류되어 건강보험 혜택을 크게 누립니다. 민간 보험사는 이에 연동하여 **'심장질환 산정특례 진단비'** 특약을 지원하며, 약관 기준에 따라 추가 지급이 가능한 산정특례 진단비 특약 구성을 검토할 수 있습니다.
            </p>

            <div className="bg-red-50/50 p-5 md:p-6 rounded-2xl border border-red-100 space-y-4">
              <p className="text-sm font-black text-red-950">💡 산정특례 진단비의 특징</p>
              <div className="space-y-2 text-[10px] text-gray-600 font-bold">
                <div className="flex justify-between p-2.5 bg-white rounded-lg border border-red-100/50">
                  ...
                  <span className="text-slate-700 font-black">보험기간 중 최초 1회 진단 시 지급 후 특약 소멸</span>
                </div>
                <div className="flex justify-between p-2.5 bg-white rounded-lg border border-red-100/50">
                  <span>산정특례 진단비 특약</span>
                  <span className="text-rose-700 font-black">공단 산정특례 등록 조건 충족 시 약관 기준 반복 지급 가능</span>
                </div>
              </div>
              <p className="text-[10px] text-red-800 font-bold leading-relaxed">
                * 대한심장학회 및 임상 통계 기준 심혈관 질환은 재발 및 재시술 가능성이 존재하므로, 약관 기준 충족 시 추가 지원되는 산정특례 및 수술비 특약 구성을 검토할 수 있습니다 (회사별 약관 기준 상이).
              </p>
            </div>
          </div>
          ...
          <div className="p-5 md:p-6 bg-slate-50 rounded-2xl border border-slate-100">
            ...
            <p className="text-[11px] text-gray-600 font-bold leading-relaxed">
              "스텐트 시술 후 약물 복용을 이어가며 장기 관리를 해야 하는 환자들은 진단비 1회 일시금과 더불어, 약관 기준에 따라 회당 지급되는 '심장질환 수술비' 특약의 조화를 함께 고려하는 것이 장기 유지에 효과적입니다."
            </p>
          </div>
        </div>
      </div>

      {/* ── 5. 주요 손해보험사 심장질환보험 상품별 특징 비교 ── */}
      <div className="space-y-8">
        <div className="text-center space-y-4">
          ...
          <h3 className="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">
            주요 손해보험사 심장질환보험 상품별 특징 비교 (손해보험협회 공시 기준)
          </h3>
          <p className="text-xs text-gray-400 font-bold max-w-lg mx-auto leading-relaxed">
            보험사별로 부정맥 진단 범위, 혈관 시술비 보장 특징 및 납입면제 범위를 객관적으로 분석한 정보입니다.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: '한 번 진단비를 수령하면 소멸하는 일반 담보의 한계를 보완하여, 협심증(I20) 및 급성심근경색(I21) 등의 질병 영역을 각각 개별 담보로 분류하여 각 영역별 최초 진단 시 진단금을 지급합니다.',
            ...
            },
            {
              ...
              highlight: '스텐트 삽입술 등 매회 정액 보장',
              desc: '스텐트 삽입술 등 관상동맥 협착 시술 청구 시 약관 기준에 따라 매 수술 시마다 정액 보상을 제공하여 장기적 혈관 시술 고객에게 유리합니다.',
              strength: '혈관 확장 및 수술 특약 연계 설계'
            },
            {
              company: '현대해상',
              badge: '판막/심박동기 특화',
              badgeColor: 'bg-orange-50 text-orange-700 border-orange-200',
              highlight: '경피적 심장판막 및 인공심박동기 한도 구성 우수',
              desc: '부정맥 환자의 시술인 인공심박동기(Pacemaker) 이식 한도를 경쟁력 있게 보강 설계할 수 있어 고령층 실버 플랜 연계 계약에서 장점을 보입니다.',
              strength: '심장 판막 및 심박 조율 장치 특약 경쟁력 확보'
            },
            {
              company: '메리츠화재',
              badge: '부정맥 담보 특화',
              badgeColor: 'bg-rose-50 text-rose-700 border-rose-200',
              highlight: '기타 심장 부정맥(I49) 진단비 한도 세팅',
              desc: '간편 심사 연계를 통해 부정맥(I49) 보장 한도를 경쟁력 있게 보완하도록 지원하여 가입 유연성을 높였습니다.',
              strength: '기타 심장 부정맥(I49) 집중형 설계'
            },
            {
              company: 'KB손해보험',
              badge: '산정특례 특화 플랜',
              ...
              desc: '심장 질환으로 중증 산정특례 대상자로 등록될 경우, 특례 조건 충족 시 약관에 따라 연간 반복 지급하는 위로금 가입 한도를 경쟁력 있게 세팅해 줍니다.',
              strength: '재발 위험 대비를 위한 산정특례 위로금 특화'
            },
            {
              company: '한화손해보험',
              badge: '합리적 요율 매칭',
              badgeColor: 'bg-purple-50 text-purple-700 border-purple-200',
              highlight: '허혈성 심장질환 진단 특약 합리적 요율 구성',
              desc: '30대 및 40대 경제 활동 연령층의 허혈성 심장질환 진단비 특약 당 보험료 단가를 합리적인 수준으로 산정하여, 기존 가입된 좁은 급성심근경색 보장을 보완하기에 적격입니다.',
              strength: '기본 보장 보완용 가성비 요율 매칭'
            }
          ].map((item, index) => (
            <div 
              key={index} 
          ...
          {[
            {
              ...
              desc: '보장 특약명이 "급성심근경색증"에 국한되어 있는 경우, 다빈도 협심증이나 부정맥 진단 시 보장 대상에서 제외될 수 있으므로 "허혈성" 및 "심장질환" 담보로 보완 리모델링을 검토하셔야 합니다.'
            },
            {
              step: '02',
              title: '건강검진 심전도 검사 전 가입 설계하기',
              desc: '가슴 답답함, 숨 가쁨 증상이 있어 병원 방문을 예정하고 있거나 건강검진(심전도)을 앞두고 있다면 검사 전에 심장 플랜을 설계하여 가입을 마치는 것이 소견 발생에 따른 부담보를 방어하는 데 유리합니다.'
            },
            {
              step: '03',
              title: '매회 반복되는 스텐트 시술 수술비 추가',
              desc: '스텐트 삽입술 등 관상동맥 시술은 환자에 따라 수년 내 추가 시술이 필요한 경우가 있습니다. 1회성 진단비의 한계를 보완하기 위해 약관 기준에 따라 지급되는 "심장 수술비" 담보 유무를 비교 대조하세요.'
            },
            {
              step: '04',
              title: '뇌혈관과 심혈관의 1:1 균형 비율 설계',
              desc: '뇌와 심장은 우리 몸의 2대 혈관 시스템으로 밀접하게 연결되어 있습니다. 어느 한쪽 보장 진단비 규모가 쏠리지 않도록 뇌혈관 진단비와 심장질환 진단비 한도를 균형 있게 맞추어 설계하는 것이 권장됩니다.'
            }
          ].map((item, idx) => (
      ...
      <div className="bg-gradient-to-br from-red-900 to-red-950 rounded-3xl md:rounded-[3rem] p-5 md:p-8 md:p-12 text-center text-white relative overflow-hidden shadow-xl border border-red-500/20">
        ...
        <div className="relative z-10 space-y-6 max-w-2xl mx-auto">
          <h3 className="text-xl md:text-2xl font-black">
            ...
            <span className="text-red-300">공시 기준 데이터를 바탕으로 심장질환 보장 상태를 지금 확인해 보세요.</span>
          </h3>
          <p className="text-xs text-red-200/70 font-semibold leading-relaxed">
            가입 연령과 성별을 기반으로 손해보험협회 공시 자료를 객관적으로 대조하여, 카테터 스텐트 시술비와 허혈성·심혈관 질환 특약의 합리적인 맞춤 설계를 안내해 드립니다.
          </p>
