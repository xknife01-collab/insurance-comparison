              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-2">
                  <p className="text-[0.85rem] font-bold text-gray-600 leading-relaxed">
                    설정하신 월 예산에 맞춰 뇌혈관 질환 예상 한도가 <span className="text-indigo-600 font-black underline decoration-2 underline-offset-4">{metrics.benefit.toLocaleString()}만 원</span>으로 연동 조율되는 것을 확인하실 수 있습니다.
                  </p>
                </div>
              </div>
            </div>
