        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 text-xs text-slate-600 space-y-2 leading-relaxed">
            ...
            <div className="pt-2 border-t border-indigo-100 text-[11px] text-slate-500 space-y-1">
              ...
              <p>• **진단 확정 요건 안내**: 뇌혈관질환의 진단 확정은 의료법 제3조에 의한 병원 또는 의원의 신경과, 신경외과, 영상의학과 전문의 자격을 가진 자에 의하여 내려져야 하며, 뇌 전산화단층촬영(CT), 자기공명영상(MRI), 뇌혈관조영술 등의 정밀검사 결과를 기초로 해야 합니다.</p>
              <p>• **외상성 뇌손상 등 보장 제외**: 외상에 의한 뇌출혈(S코드) 및 뇌종양 등 질병분류코드(I60~I69) 이외의 원인으로 발생한 뇌 손상은 일반 질병 뇌혈관질환 진단비 지급 대상에서 제외될 수 있습니다.</p>
