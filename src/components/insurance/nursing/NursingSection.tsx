        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 text-xs text-slate-700 space-y-3 leading-relaxed">
            ...
            <div className="pt-2.5 border-t border-pink-200 text-[11px] text-slate-600 space-y-1.5">
              <p>• **재가급여 매월 지급 필수 요건**: 재가급여 지원금은 단순히 장기요양 1~5등급 판정만으로 자동 지급되지 않으며, 공인된 장기요양기관을 통해 방문요양·방문목욕·주야간보호·방문간호 등을 **월 1회 이상 실제로 이용하고 급여이용기록지(영수증)가 제출되어야 매월 지급**됩니다 (단, 복지용구 대여 및 구입만 단독으로 이용한 달은 회사별 약관에 따라 재가급여 지원금 지급 대상에서 제외될 수 있습니다).</p>
