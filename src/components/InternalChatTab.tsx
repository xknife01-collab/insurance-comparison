...
export function InternalChatTab({ currentUser, showHelpGuide = false, onToggleHelpGuide, initialRoomId, onClearInitialRoomId }: InternalChatTabProps) {
  ...
  return (
    <div className="flex flex-col h-[600px] sm:h-[680px] bg-slate-950/80 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl shadow-violet-950/10 text-left border border-violet-500/20">
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[10px] truncate mt-1 max-w-[150px] text-slate-400">{room.lastMessage}</p>
                      </div>
                    </div>
          ...
          {selectedRoom ? (
            <>
              ...
              <div className="flex-1 flex overflow-hidden">
                ...
                {showFaqDrawer && (
                  <div className="absolute md:relative right-0 top-0 bottom-0 z-30 w-full md:w-80 border-l border-slate-800/80 bg-slate-950/95 md:bg-slate-950/60 flex flex-col p-4 overflow-y-auto animate-in slide-in-from-right duration-355 shrink-0">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-slate-950/10 overflow-y-auto">
              ...
              <p className="text-xs text-slate-400 max-w-sm mt-2 leading-relaxed break-keep">
                총관리자, 대리점 및 소속 설계사 간의 실시간 1:1 대화방을 지원합니다.
                <br />
