...
▶ 우리 서비스 특징
  ...
  - 본인인증을 완료하시면 1:1 실시간 상담 시 블라인드 처리된 구체적인 회사명 및 상품명이 투명하고 상세하게 안내됩니다.
...
- 위 요율/규정/약관 사실에 기반하여 질문에 정밀하게 답변하십시오. 절대 거짓이나 임의의 수치로 상상하여 답변하지 마십시오.`;
  ...
  if (customerSegment) {
    ...
    if (customerSegment === 'price_sensitive') {
      ...
      guideText = `- 장황한 인사말, 장황한 공감 리액션, 이모지 남발을 최소화하십시오.\n- 묻는 말에 1~2줄로 바로 답변하고, "본인인증을 하시면 1:1 실시간 상담 시 구체적인 상품 정보가 상세히 안내된다"처럼 다음 목표 행동 링크를 즉시 제시하십시오.`;
    }
