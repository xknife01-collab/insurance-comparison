...
export const analyzeSavings = (analysis: any): any => {
  ...
  let hybridDesc = '비과세 혜택의 법정 최고 한도를 가득 채우고, 추가 납입 기능을 동원해 사업비 차감 비율을 최저로 떨어트리는 프리미엄 자산가형 세팅입니다.';
  ...
  if (savingsObjective === 'marriage') {
    ...
    hybridDesc = '결혼 최고 목표 자금 형성을 위해 세법 최고 한도를 채우며 추가 납입 기능(사업비 면제)을 극대화하여 조기 적립 속도를 올리는 프리미엄 결혼 자산 플랜입니다.';
    ...
    upgradeDesc = '주택 청약이나 분양 대금 납입 시점에 맞춰 비과세(15.4% 면제)를 완벽히 확보하고 연금형 복리로 자산을 팽창시키는 밸런스형 플랜입니다.';
    hybridDesc = '대형 주택 계약금 또는 중도금 마련을 위해 최고 한도 세팅 및 추가 적립 효율을 최대로 활용하는 고액 자산 형성 부스터 플랜입니다.';
    ...
    hybridDesc = '노후 은퇴 자산의 최고 효율 극대화를 겨냥하여 최고 한도액을 거치 또는 적립하고 대기업의 최저보증이율 안전망을 활용하는 은퇴 마스터 플랜입니다.';
    ...
    hybridDesc = '자녀에게 풍요로운 미래 자산을 안전하게 양도하기 위해 최고 한도 세팅 및 유니버셜 추가납입을 결합해 증여 가치를 극대화한 프리미엄 패밀리 플랜입니다.';
  }
  ...
  const hybrid: RecommendationPlan = {
    ...
    switchingLossNotice: `최고 한도를 초과하여 납입된 금액은 일반 과세(15.4% 세율)로 분류되므로 추가 저축 시 금융종합과세 한도 등을 고려하여 계좌를 분할해야 합니다.`,
    isFire: false
  } as any;
