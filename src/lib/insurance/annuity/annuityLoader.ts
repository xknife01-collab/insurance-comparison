...
export const fetchAnnuityPremium = async (analysis: InsuranceAnalysis): Promise<any> => {
  ...
  if (productsList.length === 0) {
    productsList = [
      ...
      { company: '삼성생명', productName: '인터넷 연금저축보험 (무배당)', annuityType: 'savings', declaredRate: 2.85, guaranteedRate: 0.75, businessFee: 5.2, features: "인터넷 CM 전용 최저 수수료(사업비 5.2%) | 안정적인 고금리 이율 (2.85 %) | 자산 규모 1위 삼성금융 브랜드의 절대 안정성" },
      ...
      { company: '삼성생명', productName: '인터넷 연금보험 (무배당, 비과세)', annuityType: 'insurance', declaredRate: 2.80, guaranteedRate: 0.75, businessFee: 5.8, features: "인터넷 CM 전용 최저 수수료(사업비 5.8%) | 안정 보장형 복리 이율 (2.80 %) | 자산 규모 1위 삼성금융 브랜드의 절대 안정성" },
