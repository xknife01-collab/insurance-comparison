...
def update_disclosure_dates():
    print(f"\n[*] Updating dementia disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["dementia"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("       DEMENTIA INSURANCE PIPELINE RUNNER        ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("scripts/extract_dementia_data.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Restructuring...")
    if not run_script("scripts/restructure_dementia_data.py"):
        print("[-] Restructuring failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("scripts/upload_dementia_rates.py"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("    ★ DEMENTIA UPDATE COMPLETED SUCCESSFULLY! ★")
    print("==================================================")
