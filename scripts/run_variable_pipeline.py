...
def update_disclosure_dates():
    print(f"\n[*] Updating variable disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["variable"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("        VARIABLE INSURANCE PIPELINE               ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("python", "scripts/extract_variable_term.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("npx tsx", "scripts/upload_variable_term_rates.ts"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("★  VARIABLE UPDATE COMPLETED SUCCESSFULLY!  ★")
    print("==================================================")
