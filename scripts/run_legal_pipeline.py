...
def update_disclosure_dates():
    print(f"\n[*] Updating legal disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["legal"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("        LEGAL INSURANCE PIPELINE RUNNER           ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("scripts/extract_legal_data.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("scripts/upload_legal_data_http.py"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("  ★ LEGAL INSURANCE UPDATE COMPLETED SUCCESSFULLY! ★")
    print("==================================================")
