...
def update_disclosure_dates():
    print(f"\n[*] Updating home facility (nursing) disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["nursing"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("    HOME & FACILITY NURSING PIPELINE RUNNER       ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("scripts/extract_home_facility_data.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("scripts/upload_home_facility_rates.py"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("  ★ NURSING UPDATE COMPLETED SUCCESSFULLY! ★")
    print("==================================================")
