...
def update_disclosure_dates():
    print(f"\n[*] Updating caregiving disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["caregiving"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("      CAREGIVING INSURANCE PIPELINE RUNNER        ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("scripts/extract_caregiving_data.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("scripts/upload_caregiving_rates.py"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("  ★ CAREGIVING UPDATE COMPLETED SUCCESSFULLY! ★")
    print("==================================================")
