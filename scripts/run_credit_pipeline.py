...
def update_disclosure_dates():
    print(f"\n[*] Updating credit disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["credit"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("       CREDIT INSURANCE PIPELINE RUNNER           ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("scripts/extract_credit_data.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("scripts/upload_credit_rates_http.py"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("  ★ CREDIT UPDATE COMPLETED SUCCESSFULLY! ★")
    print("==================================================")
