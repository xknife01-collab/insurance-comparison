...
def update_disclosure_dates():
    print(f"\n[*] Updating driver disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["driver"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("         DRIVER INSURANCE PIPELINE RUNNER         ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("scripts/scraper/extract_driver_final.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("scripts/scraper/load_driver_to_supabase_api.py"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("  ★ DRIVER INSURANCE UPDATE COMPLETED SUCCESSFULLY! ★")
    print("==================================================")
