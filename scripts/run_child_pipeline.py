...
def update_disclosure_dates():
    print(f"\n[*] Updating child disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
...
def main():
    print("==================================================")
    print("          CHILD INSURANCE PIPELINE RUNNER         ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("scripts/extract_child_excel_aligned.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("scripts/upload_child_rates.py"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("  ★ CHILD INSURANCE UPDATE COMPLETED SUCCESSFULLY! ★")
    print("==================================================")
