...
def update_disclosure_dates():
    print(f"\n[*] Updating golf disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["golf"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("         GOLF INSURANCE PIPELINE RUNNER           ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("scripts/extract_golf_data.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("scripts/upload_golf_rates.py"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("  ★ GOLF INSURANCE UPDATE COMPLETED SUCCESSFULLY! ★")
    print("==================================================")
