...
def update_disclosure_dates():
    print(f"\n[*] Updating whole_life disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["whole_life"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("        WHOLE LIFE INSURANCE PIPELINE             ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("python", "scripts/extract_whole_life_aligned.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("npx tsx", "scripts/upload_whole_life_rates.ts"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("★  WHOLE LIFE UPDATE COMPLETED SUCCESSFULLY!  ★")
    print("==================================================")
