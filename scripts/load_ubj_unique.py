"""
유병자 보험 최종 적재 스크립트 (UNIQUE PATCH)
- 상품명 중복을 파이썬 단에서 제거하여 409 Conflict 해결
"""
import pandas as pd
import os
import re
...
def do_load_unique():
    ...
    print(f"[*] RE-LOADING (UNIQUE MODE)...")
    ...
    for fname in TARGET_FILES:
        ...
        for _, row in df.iterrows():
            ...
            batch.append({
                "company_name": c, "product_name": pn, "category": "건강보험", "review_type": "간편심사",
    ...
    print(f"[*] FINAL SUCCESS: {total} unique products loaded.")
