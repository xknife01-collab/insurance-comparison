...
def update_disclosure_dates():
    print(f"\n[*] Updating pet disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["pet"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("          PET INSURANCE PIPELINE RUNNER           ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("scripts/extract_pet_data.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("scripts/upload_pet_rates.py"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("  ★ PET INSURANCE UPDATE COMPLETED SUCCESSFULLY! ★")
    print("==================================================")
