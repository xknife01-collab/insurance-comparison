...
TARGET_DIR = r"c:\Users\zkfnt\Desktop\insurance-comparison-main\insurance-comparison-main\insurance_data\3_family\child"
...
CHILD_KEYWORDS = ["어린이", "자녀", "태아", "꿈나무", "신생아", "아이"]
    ...
    for filename in sorted(files):
        ...
        try:
            ...
            for idx, row in df.iterrows():
                ...
                is_exclude = any(k in product_name for k in EXCLUDE_KEYWORDS)
                
                if is_child and not is_exclude:
            ...
            if file_child_rows > 0:
                print(f"  - {filename}: {file_child_rows}개 어린이/태아보험 담보 추출")
