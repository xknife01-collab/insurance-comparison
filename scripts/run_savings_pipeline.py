...
def update_disclosure_dates():
    print(f"\n[*] Updating savings disclosure metadata in {METADATA_JSON_PATH}...")
    try:
        now = datetime.now()
        ...
        data["savings_general"] = current_disclosure_str
...
def main():
    print("==================================================")
    print("       SAVINGS INSURANCE PIPELINE RUNNER          ")
    print("==================================================")
    ...
    print("\n[+] Running Extraction...")
    if not run_script("scripts/extract_savings_data.py"):
        print("[-] Extraction failed!")
        sys.exit(1)
        
    print("\n[+] Running Upload...")
    if not run_script("scripts/upload_savings_rates_new.py"):
        print("[-] Upload failed!")
        sys.exit(1)
    ...
    print("\n==================================================")
    print("  ★ SAVINGS UPDATE COMPLETED SUCCESSFULLY! ★")
    print("==================================================")
