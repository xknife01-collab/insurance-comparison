...
# Exclusion keywords (Focus ONLY on product type, NOT premium)
...
for file in all_files:
    ...
    for tr in rows:
        ...
        # --- PRECISE FILTERING ---
        # Only exclude by product type keywords. NO PREMIUM CAP.
...
print(f"\nFinal REFINED Surgery Extraction: {len(final_combined)} products.")
