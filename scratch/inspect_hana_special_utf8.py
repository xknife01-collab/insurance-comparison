...
with open("scratch/special_utf8.txt", "w", encoding="utf-8") as out:
    for idx, row in df.iterrows():
        ...
        if idx in rows_to_check:
            out.write(f"Row {idx} belongs to product: {current_product} (company: {current_company})\n")

print("Written to scratch/special_utf8.txt")
