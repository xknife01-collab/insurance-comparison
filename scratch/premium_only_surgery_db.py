...
RATIO = 1.36
MIN_PREMIUM = 30000 # New threshold: Exclude everything below 30,000 Won
...
print(f"Uploading {len(final_items)} PREMIUM surgery products (>= 30,000 Won) to Supabase...")
...
print("PREMIUM DB RELOAD COMPLETE.")
