...
csv_path = r"c:\Users\zkfnt\Desktop\insurance-comparison-main\insurance-comparison-main\insurance_data\1_guaranteed\accident\extracted_data_combined.csv"
...
try:
    ...
    print(f"| 보험회사 | 상품명 | 합산 기준보험료 (남성) | 합산 가입보험료 (여성) |")
    print(f"| --- | --- | --- | --- |")
