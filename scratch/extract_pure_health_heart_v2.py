...
def extract_pure_health_heart_v2():
    parent_dir = r"C:\Users\zkfnt\Desktop\insurance-comparison-main"
    # 충돌 방지를 위해 파일명 변경
    save_path = r"C:\Users\zkfnt\Desktop\insurance-comparison-main\insurance-comparison-main\insurance_data\1_guaranteed\heart\heart_master_standard_pure.csv"
    ...
    if all_data:
        ...
        print(f"COMPLETE: {len(df_final)} PURE HEALTH/HEART insurance records saved to {save_path}.")
    else:
        print("No specialized data found.")

if __name__ == "__main__":
    extract_pure_health_heart_v2()
