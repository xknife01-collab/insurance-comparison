...
# STRENGTHENED Exclusion Patterns
exclude_patterns = [
...
for file in all_files:
    ...
    for tr in table.find_all('tr'):
        ...
        # STRICT FILTERING ON PRODUCT NAME
...
print(f"Uploading {len(final_items)} PURE surgery products to Supabase...")
# Ensure total wipe
...
print("ULTRA CLEAN DB RELOAD COMPLETE.")
