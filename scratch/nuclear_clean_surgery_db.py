...
# NUCLEAR-LEVEL Exclusion Patterns (Added Dental professional terms)
exclude_patterns = [
    '종신', 'CEO', '경영인', '어린이', '태아', '자녀', '유병자', '간편', 
    '325', '335', '355', '암보험', 'CI보험', '치아', '실손', '의료비', 
    '노후', '치매', '간병', '운전자', '화재', '연금', '변액', '유병력자',
    '보철', '임플란트', '틀니', '치주', '치과', '충치', '브릿지', '레진', '스케일링', '보존치료'
]
...
for file in all_files:
    ...
    for tr in table.find_all('tr'):
        ...
        # NUCLEAR FILTERING ON PRODUCT NAME
...
print(f"Uploading {len(final_items)} NUCLEAR-CLEAN surgery products to Supabase...")

# Full wipe with Service Role Key
...
print("NUCLEAR-CLEAN DB RELOAD COMPLETE.")
