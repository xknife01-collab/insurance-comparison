...
RATIO = 1.36
MIN_PREMIUM = 0 # REMOVED PREMIUM LIMIT
...
print(f"Uploading {len(final_items)} UNLIMITED surgery products to Supabase...")
...
print("UNLIMITED DB RELOAD COMPLETE.")
