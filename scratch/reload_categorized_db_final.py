...
if os.path.exists(env_path):
    with open(env_path, 'r') as f:
        for line in f:
            ...
            # Use service role key for deletion if available
...
print(f"Uploading {len(final_items)} categorized products to Supabase...")
...
print("SUCCESS: 5-CATEGORY DB RELOAD COMPLETE.")
