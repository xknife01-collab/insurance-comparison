...
def final_pure_health_overwrite():
    ...
    contact_map = {
        ...
        "삼성생명": "1588-3366", "교보생명": "1588-5588", "한화생명": "1588-6363"
    }
    ...
    if all_data:
        ...
        print(f"SUCCESS: {len(df_final)} PURE HEALTH insurance records saved to {save_path}.")
    else:
        print("No specialized data found.")

if __name__ == "__main__":
    final_pure_health_overwrite()
